...
const CustomRangeBarChart = () => {
    useEffect(() => {
        ...
        // console.log('Anger Data:', angerData);
        // console.log('Sadness Data:', sadnessData);
        ...
        const surpriseColor = '#f1c40f';
        const neutralColor = '#95a5a6';
        const angerColor = '#e74c3c';
        const sadnessColor = '#3498db';
